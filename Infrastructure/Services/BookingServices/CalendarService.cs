...
namespace Infrastructure.Services.BookingServices
{
    ...
    {
        public IEnumerable<AvailableSlot> GetAvailableSlots<T>(DateTime dayStart, DateTime dayEnd, T[] required)
            where T : Calendar
        {
        ...
        public IEnumerable<AvailableSlot> CalculateAvailability(IEnumerable<AvailableSlot> availableSlots, int duration)
        {

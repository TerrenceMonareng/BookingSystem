...
namespace LocalBookings.Services
{
    ...
    {
        public IEnumerable<AvailableSlot> GetAvailableSlotsForPeople(DateTime dayStart, DateTime dayEnd, Person[] required)
        {
        ...
        public AvailableSlot[] CalculateAvailableSlots(Person organiser, Person[] required, double duration)
        {
            ...
            var availableSlots = GetAvailableSlotsForPeople(DayStart, DayEnd, required.Union(new[] { organiser }).ToArray());
